...
Bu proje [MIT Lisansı](https://opensource.org/licenses/MIT) ile lisanslanmıştır. Daha fazla bilgi için [LICENSE](https://github.com/emchorian/horian-password-manager/blob/main/LICENSE) dosyasına bakabilirsiniz.
